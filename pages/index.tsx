...
export default function HomePage() {
  ...
  const codeLines = [
    ...
    { code: "    name: 'Michael Milad',", type: 'array-item' },
    { code: "    role: 'Frontend React Developer',", type: 'array-item' },
      ...
      <div className={styles.container}>
        ...
        <div className={styles.infoSection}>
          <h1 className={styles.developerName}>
            Michael <span className={styles.accentText}>Milad</span>
          </h1>

          <div className={styles.developerRole}>Frontend React Developer</div>
